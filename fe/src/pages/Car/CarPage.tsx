...
const CarPage: React.FC = () => {
  const { SanPham, XeTinhNang, Feedback } = {
    SanPham: {
      Img: "https://n1-pstg.mioto.vn/cho_thue_xe_o_to_tu_lai_thue_xe_du_lich_hochiminh/toyota_fortuner_legender_2012/p/g/2024/07/26/15/k0btqA3RnKVKxXHQi6mM3A.jpg",
      Diachixe: "123 Main St, District 1, Ho Chi Minh City",
      Gia: 1000,
      GiaVuot: "5000",
      InfoXe: {
        Loaixe: { Name: "Toyota Camry" },
        Truyendong: 1,
        Soghe: 5,
        LoaiNl: "1",
        Mota: "A reliable and comfortable sedan with excellent fuel efficiency and spacious interior.",
      },
    },
    XeTinhNang: [
      { Name: "Bluetooth" },
    ...
    Feedback: [
      {
        InfoUserCus: { Name: "Nguyen Van A" },
        Noidung: "Xe chạy êm, tiết kiệm nhiên liệu, giá cả hợp lý.",
        Danhgia: 4,
      },
      {
        InfoUserCus: { Name: "Tran Thi B" },
        Noidung: "Xe rất mới và sạch sẽ, tôi hài lòng với dịch vụ.",
        Danhgia: 5,
      },
      {
        InfoUserCus: { Name: "Le Van C" },
        Noidung: "Giá thuê cao hơn so với một số nơi khác, nhưng dịch vụ tốt.",
        Danhgia: 3,
      },
    ],
  };
  ...
  return (
    <div className="max-w-[1280px] mx-auto p-4">
        <div className="flex justify-between gap-8 mb-8">
            <img src={`${car?.imgUrl}`} alt="Car" className="h-[600px] w-[60%] rounded-2xl object-cover" />
            <div className="w-[40%] flex flex-col gap-2">
                <img src={`${car?.imgUrl}`} alt="Car" className="h-[190px] object-cover rounded-2xl" />
                <img src={`${car?.imgUrl}`} alt="Car" className="h-[200px] object-cover rounded-2xl" />
                <img src={`${SanPham.Img}`} alt="Car" className="h-[200px] object-cover rounded-2xl" />
            </div>
        </div>
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="md:col-span-2">
          <div className="py-4 border-b">
            <h1 className="text-4xl font-semibold uppercase">{SanPham.InfoXe.Loaixe.Name}</h1>
            ...
            <div className="flex gap-4">
                <p className="mt-2 bg-[#eef7ff] px-2 py-1 my-4 rounded-full text-sm w-fit">
                    {SanPham.InfoXe.Truyendong === 1 ? 'Số tự động' : 'Số sàn'}
                </p>
            ...
            <div className="flex gap-4 mt-2">
              <div className="flex items-center flex-1">
                ...
                <div className="ml-2">
                  ...
                  <p className="font-semibold text-xl">{SanPham.InfoXe.Truyendong === 1 ? 'Số tự động' : 'Số sàn'}</p>
                </div>
              </div>
              <div className="flex items-center flex-1">
                ...
                <div className="ml-2">
                  ...
                  <p className="font-semibold text-xl">{SanPham.InfoXe.Soghe}</p>
                </div>
              </div>
              <div className="flex items-center flex-1">
                ...
                <div className="ml-2">
                  ...
                  <p className="font-semibold text-xl">
                    {SanPham.InfoXe.LoaiNl === '1' ? 'Xăng' : SanPham.InfoXe.LoaiNl === '2' ? 'Dầu' : 'Điện'}
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="py-4 border-b">
            ...
            <p className="text-[#767676]">{SanPham.InfoXe.Mota}</p>
          </div>
          ...
          <div className="py-4 border-b">
            ...
            <ul className="grid grid-cols-4 gap-y-6">
                <li className="flex gap-2">
                    <img className="w-6 h-6" loading="lazy" src="https://n1-cstg.mioto.vn/v4/p/m/icons/features/map-v2.png" alt="Mioto - Thuê xe tự lái"/>
                     Bản đồ
                </li>
                <li className="flex gap-2">
                    <img className="w-6 h-6" loading="lazy" src="https://n1-cstg.mioto.vn/v4/p/m/icons/features/bluetooth-v2.png" alt="Mioto - Thuê xe tự lái"/> 
                    Bluetooth
                </li>
                <li className="flex gap-2">
                    <img className="w-6 h-6" loading="lazy" src="https://n1-cstg.mioto.vn/v4/p/m/icons/features/dash_camera-v2.png" alt="Mioto - Thuê xe tự lái"/> 
                    Camera hành trình
                </li>
                <li className="flex gap-2">
                    <img className="w-6 h-6" loading="lazy" src="https://n1-cstg.mioto.vn/v4/p/m/icons/features/reverse_camera-v2.png" alt="Mioto - Thuê xe tự lái"/>
                     Camera lùi
                </li>
                <li className="flex gap-2">
                    <img className="w-6 h-6" loading="lazy" src="https://n1-cstg.mioto.vn/v4/p/m/icons/features/tpms-v2.png" alt="Mioto - Thuê xe tự lái"/>
                     Cảm biến lốp
                </li>
                <li className="flex gap-2">
                    <img className="w-6 h-6" loading="lazy" src="https://n1-cstg.mioto.vn/v4/p/m/icons/features/impact_sensor-v2.png" alt="Mioto - Thuê xe tự lái"/> 
                    Cảm biến va chạm
                </li>
                <li className="flex gap-2">
                    <img className="w-6 h-6" loading="lazy" src="https://n1-cstg.mioto.vn/v4/p/m/icons/features/gps-v2.png" alt="Mioto - Thuê xe tự lái"/>
                     Định vị GPS
                </li>
                <li className="flex gap-2">
                    <img className="w-6 h-6" loading="lazy" src="https://n1-cstg.mioto.vn/v4/p/m/icons/features/etc-v2.png" alt="Mioto - Thuê xe tự lái"/> 
                    ETC
                </li>
            </ul>
          </div>
                ...
                {Feedback.map((cmt, index) => (
                  <li key={index} className="border-b py-2">
                    <div className="flex items-center">
                      ...
                      <span>{cmt.InfoUserCus.Name}</span>
                    </div>
        ...
        <div>
          <div className="p-4 mb-4 bg-[#f7fbff] rounded-lg">
            <h4 className="text-xl font-bold mb-3"><span className="text-3xl">{SanPham.Gia}K</span> <span className="text-lg text-gray-400">/ ngày</span></h4>
            <div className="grid grid-cols-2 gap-4 mb-3">
              <div>
                <label>Nhận xe</label>
                <input type="date" placeholder="Ngày checkin" className="w-full mt-1 p-2 border rounded" />
              </div>
              <div>
                <label>Trả xe</label>
                <input type="date" placeholder="Ngày checkout" className="w-full mt-1 p-2 border rounded" />
              </div>
              <div className="col-span-2">
                <label>Địa điểm nhận xe</label>
                <input type="text" placeholder="Vị trí giao" className="w-full mt-1 p-2 border rounded" />
              </div>
            </div>
              ...
              <li className="flex text-sm gap-2">
                ...
                <div className="flex justify-between flex-col">
                    <div className="flex justify-between font-semibold">
                        ...
                        <span>{SanPham.GiaVuot} đ/h</span>
                    </div>
                    <span className="text-sm text-[#666666]">Phụ phí phát sinh nếu hoàn trả xe trễ giờ. Trường hợp trễ quá 5 giờ, phụ phí thêm 1 ngày thuê</span>
                </div>
              </li>
              <li className="flex text-sm gap-2">
                <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M8 7.33398V10.4407" stroke="#666666" strokeLinecap="round" strokeLinejoin="round"></path><path d="M8 6.05469C8.27614 6.05469 8.5 5.83083 8.5 5.55469C8.5 5.27855 8.27614 5.05469 8 5.05469C7.72386 5.05469 7.5 5.27855 7.5 5.55469C7.5 5.83083 7.72386 6.05469 8 6.05469Z" fill="#666666"></path><path d="M7.99967 14.1673C11.4054 14.1673 14.1663 11.4064 14.1663 8.00065C14.1663 4.5949 11.4054 1.83398 7.99967 1.83398C4.59392 1.83398 1.83301 4.5949 1.83301 8.00065C1.83301 11.4064 4.59392 14.1673 7.99967 14.1673Z" stroke="#666666" strokeLinecap="round" strokeLinejoin="round"></path></svg>
                <div className="flex justify-between flex-col">
                    <div className="flex justify-between font-semibold">
                        ...
                        <span>{SanPham.GiaVuot} đ</span>
                    </div>
                    <span className="text-sm text-[#666666]">Phụ phí phát sinh khi xe hoàn trả không đảm bảo vệ sinh (nhiều vết bẩn, bùn cát, sình lầy...)</span>
                </div>
              </li>
              <li className="flex text-sm gap-2">
                <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M8 7.33398V10.4407" stroke="#666666" strokeLinecap="round" strokeLinejoin="round"></path><path d="M8 6.05469C8.27614 6.05469 8.5 5.83083 8.5 5.55469C8.5 5.27855 8.27614 5.05469 8 5.05469C7.72386 5.05469 7.5 5.27855 7.5 5.55469C7.5 5.83083 7.72386 6.05469 8 6.05469Z" fill="#666666"></path><path d="M7.99967 14.1673C11.4054 14.1673 14.1663 11.4064 14.1663 8.00065C14.1663 4.5949 11.4054 1.83398 7.99967 1.83398C4.59392 1.83398 1.83301 4.5949 1.83301 8.00065C1.83301 11.4064 4.59392 14.1673 7.99967 14.1673Z" stroke="#666666" strokeLinecap="round" strokeLinejoin="round"></path></svg>
                <div className="flex justify-between flex-col">
                    ...
                    <span className="text-sm text-[#666666]">Phụ phí phát sinh khi xe hoàn trả bị ám mùi khó chịu (mùi thuốc lá, thực phẩm nặng mùi...)</span>
                </div>
              </li>
            </ul>
          </div>
